...
class StatusRepository {
    ...
    try {
      ...
      for (int i = 0; i < contacts.length; i++) {
        if(contacts[i].phones.isNotEmpty){
          var phoneNumber= contacts[i].phones[0].number.replaceAll(
                    ' ',
                    '',
                  );
      ...
      var statusesSnapshot = await firestore
          ...
          .get();
      print("statusesSnapshot.docs.isNotEmpty");
      print(statusesSnapshot.docs.isNotEmpty);
  ...
  Future<List<Status>> getStatus(BuildContext context) async {
    ...
    try {
      ...
      for (int i = 0; i < contacts.length; i++) {
        // thats why you need to enable index because two where
        var statusesSnapshot = await firestore
            .collection('status')
            .where('phoneNumber',
